  ...
  (function($, window) {
    ...
    OffcanvasTouch = (function() {
      ...
      OffcanvasTouch.prototype._touchEnd = function(e) {
        ...
        if (this.element.hasClass('in') && end) {
          ...
          this.button.removeClass('is-open-a');
          sendEvents = true;
        } else if (Math.abs(x - this.startX) > this.endThreshold && this.startX > this.startThreshold && this.startX < this.maxStartThreshold) {
          this.currentX = this.element.hasClass('navbar-offcanvas-right') ? -this.element.outerWidth() : this.element.outerWidth();
          this.element.toggleClass('in').css(this._clearCss());
          this.button.toggleClass('is-open-a');
          sendEvents = true;
        } else {
    ...
    window.Offcanvas = Offcanvas = (function() {
      ...
      Offcanvas.prototype._clicked = function(e) {
        ...
        this.element.toggleClass('is-open-a');
        this._navbarHeight();
      ...
      Offcanvas.prototype._open = function(e) {
        ...
        this.element.addClass('is-open-a');
        this._navbarHeight();
        return this.bodyOverflow();
      };
      ...
      Offcanvas.prototype._close = function(e) {
        ...
        this.element.removeClass('is-open-a');
        this._navbarHeight();
        return this.bodyOverflow();
      };
    ...
    return $(function() {
      ...
      $(window).on('resize', function() {
        ...
        return $('.offcanvas-toggle').removeClass('is-open-a');
      });
